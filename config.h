...
static const char *fonts[]          = { "JetBrains Mono:size=12", "Symbols Nerd Font Mono:style=Regular:size=12:antialias=true:autohint=true", "Noto Color Emoji:style=Regular:pixelsize=16:antialias=true:autohint=true"};
